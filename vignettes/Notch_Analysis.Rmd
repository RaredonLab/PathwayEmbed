...
COI_2_matrix <- as.matrix(GetAssayData(COI_2, assay = "RNA", slot = "data"))
COI_2_metadata <- COI_2@meta.data

# Compute using PathwayEmbed
pathway_data <- ComputeCellData(COI_2_matrix, "Notch", "manhattan")
to_plot <- PreparePlotData(COI_2_metadata, pathway_data, "condition")
